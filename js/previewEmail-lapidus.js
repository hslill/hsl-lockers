...
async function updateEmailPreview() {
    ...
    let emailPreview = `
        ...
        <p>Best regards,</p>
<p><strong>Document Delivery Services</strong><br>NYU Health Sciences Library (Lapidus)</p>
<p class="MsoNormal"><span style="font-family: 'Arial',sans-serif; color: #580f8b;">NYU Langone Health&nbsp;</span><br>
<span color: #63666a;">NYU Grossman School of Medicine></span><br>550 First Avenue
  <br>New York, NY 10016
  <br>T 212-263-8733
<br><a href="mailto:dds@med.nyu.edu">dds@med.nyu.edu</a>
  <br>
  <a href="https://nyulangone.org" target="_blank" rel="noopener">nyulangone.org</a>
    `;
